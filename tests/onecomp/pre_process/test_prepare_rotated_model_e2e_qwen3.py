"""E2E smoke tests for prepare_rotated_model with Qwen3-0.6B.
...
Usage::
    ...
    pytest tests/onecomp/pre_process/test_prepare_rotated_model_e2e_qwen3.py -v -s --log-cli-level=INFO
"""
...
from .conftest import E2E_FAST, QWEN3_ID


def _e2e_cases():
    cases = []
    tag, mid = "qwen3", QWEN3_ID
...
class TestPrepareRotatedModelE2EQwen3:
    """E2E smoke tests for prepare_rotated_model with Qwen3-0.6B."""
