"""
Example: GPTQ quantization + LoRA SFT + save/load (low VRAM settings)

End-to-end demonstration of the LoRA SFT post-process workflow with
settings chosen to reduce GPU memory usage on smaller GPUs:
    1. Quantize TinyLlama with GPTQ 4-bit (groupsize=128)
    2. Apply LoRA SFT post-process (WikiText-2) with reduced VRAM settings
...
Recommended low-VRAM changes compared with the standard example:
    - batch_size=1
...
Usage:
    python example/post_process/example_lora_sft_low_vram.py
"""
...
SAVE_DIR = "./tinyllama_gptq4_lora_low_vram"
PROMPT = "Fujitsu is"
...
# ================================================================
print("=" * 70)
print("Step 1: Quantize TinyLlama (GPTQ 4-bit) + LoRA SFT (WikiText-2, low VRAM)")
print("=" * 70)
